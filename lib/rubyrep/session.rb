...
module RR
  ...
  class Session
    ...
    def database_unreachable?(database)
      ...
      Thread.new do
        begin
          printf "### Thread %p database_unreachable?\n", Thread.current.object_id
    ...
    def disconnect_database(database)
      ...
      printf "### Thread: %p disconnect_database connection_id: %p\n", Thread.current.object_id, connection.connection.id
    ...
    def refresh_database_connection(database, options)
      printf "### Thread: %p refresh_database_connection\n", Thread.current.object_id
